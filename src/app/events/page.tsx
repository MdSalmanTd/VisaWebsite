    ...
    <>
      ...
      <section className="py-16 bg-linear-to-b from-white to-[#F5F5FF]">
        <div className="max-w-7xl mx-auto px-6">
            ...
            {events.map((event) => (
              ...
              >
                ...
                <div className="relative h-56 w-full overflow-hidden">
                  ...
                  />
                  <div className="absolute inset-0 bg-linear-to-t from-[#0F4C8A]/90 via-[#0F4C8A]/50 to-transparent opacity-80" />
                  
                  {/* Category Badge */}
                  <div className="absolute top-4 right-4">
                    <span className="bg-white text-[#0F4C8A] px-4 py-1.5 rounded-full text-xs font-bold shadow-lg">
                      {event.category}
                    </span>
                  </div>
                  ...
                  <div className="absolute bottom-4 left-4">
                    <div className="bg-white rounded-lg p-3 shadow-xl text-center min-w-17.5">
                      <p className="text-[#0F4C8A] font-bold text-lg leading-none">
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-[#0F4C8A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <details className="group/details">
                    <summary className="cursor-pointer text-[#0F4C8A] font-semibold text-sm hover:underline list-none flex items-center gap-2">
                      <span>Read More</span>
          ...
          {/* Call to Action */}
          <div className="mt-16 bg-[linear-gradient(135deg,#0053A1_0%,#024490_60%)] rounded-2xl p-8 md:p-12 text-center text-white">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a 
                href="/contact"
                className="bg-white text-[#0053A1] px-8 py-3 rounded-lg font-semibold hover:bg-[#EAF4FF] transition-all duration-300 inline-flex items-center gap-2"
              >
                Contact Us
              ...
              <a 
                ...
                className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-[#0053A1] transition-all duration-300 inline-flex items-center gap-2"
              >

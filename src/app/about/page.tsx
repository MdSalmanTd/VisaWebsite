  ...
  return (
    <>
      ...
      <AboutBlock
        ...
        description="Visacore Consultant is dedicated to guiding students through the complexities of international education. With a team of experienced professionals, we provide personalized visa assistance, program selection, and ongoing support to help students achieve their academic dreams abroad. Our commitment to excellence and tailored solutions ensures that every student’s journey is smooth, successful, and aligned with their goals. At Visacore, your academic aspirations are our priority."

      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="group p-8 bg-linear-to-br from-gray-50 to-white rounded-2xl border border-gray-100 hover:border-[#0F4C8A] hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2"
            >
              {/* Icon */}
              <div className="w-16 h-16 mb-6 flex items-center justify-center text-4xl bg-linear-to-br from-[#0F4C8A] to-[#1E6BB8] rounded-xl shadow-lg group-hover:scale-110 transition-transform duration-300">
                <span className="filter brightness-0 invert">{feature.icon}</span>
              </div>
              
              {/* Content */}
              <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-[#0F4C8A] transition-colors">
                {feature.title}
              </h3>
        ...
        {/* Stats Section */}
        <div className="mt-20 grid grid-cols-2 lg:grid-cols-4 gap-8 p-10 bg-linear-to-br from-[#0F4C8A] to-[#1E6BB8] rounded-3xl text-white">
